...
from config import Config, sq_dict
...
GraphicsDirPath = rf"{current_dir}\gui\graphics"
...
def SetAssistantStatus(Status):
    sq_dict["status"] = Status


def GetAssistantStatus():
    Status = sq_dict["status"]
    return Status
